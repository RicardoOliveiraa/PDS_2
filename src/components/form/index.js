...
import { Container, ContainerManage, Error, Base, Manage, Title, Button, Text, TextSmall, Link, Input, InputFile, Submit, MyLabel, TextArea, InputManage } from './styles/form';
...
Form.ContainerManage = function FormContainerManage({ children, ...restProps }) {
  return <ContainerManage {...restProps}>{children}</ContainerManage>;
};
