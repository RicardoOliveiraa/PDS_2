...
const Browse = (props) => {
    ...
    var series =[ 
        {title: "Tigre Rei", slug:"tiger-king", genre:"documentaries", id:"0", maturity: "0", description:"Com camisas de cores chamativas, um corte de cabelo peculiar e sua propensão a provocar e se exibir, Joe Exotic se apresenta diante dos olhos dos espectadores como um excêntrico personagem, que se define como: um gay provinciano amante dos grandes felinos"},
        {title:"Tiro Longo", slug:"long-shot", genre:"crime", id:"1", maturity: "16", description:"Ao ser preso por um assassinato que não cometeu, Juan Catalan tenta provar sua inocência usando as cenas cortadas de um programa de TV"},
        {title:"Family Guy", slug:"family-guy", genre:"comedies", id:"2", maturity: "18", description:"A história da série gira em torno dos Griffins, uma família disfuncional que consiste nos pais Peter e Lois; os filhos Meg, Chris e Stewie; e o seu animal de estimação, o cão antropomórfico Brian"},
        {title:"Patrulha Canina", slug:"paw-patrol", genre:"children", id:"3", maturity: "0", description:"A patrulha canina!"},
